...
const TopPlay = () => {
  ...
  const topFiveSongs = data?.tracks.slice(0, 5); 
  ...
  return (
    <div ref={divRef} className="xl:ml-11 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[350px] max-w-full flex flex-col">
    ...
    <div className="w-full flex flex-col mt-8">
      ...
      <Swiper
        ...
        className="mt-4"
      >
        {topFiveSongs?.slice(0, 5).map((artist) => (
          <SwiperSlide
            key={artist?.key}
